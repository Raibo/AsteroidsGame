...
Такой подход обеспечивает гибкость, модульность/переиспользуемость, уменьшает зависимость между командами разработки и дизайна,  
дает возможность использовать unit-тестирование.  
